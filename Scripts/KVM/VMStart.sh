...
#qemu-system-x86_64 -m 4096 -smp 4 -display sdl -device VGA -device nec-usb-xhci -device usb-tablet -device usb-kbd -drive if=virtio,file=/media/wq/Repository/Ubuntu/VM/00/debian-10-generic-amd64-20230222-1299-uroot-proot.qcow2,id=hd0,format=qcow2,media=disk -net nic -net tap,ifname=tap0
